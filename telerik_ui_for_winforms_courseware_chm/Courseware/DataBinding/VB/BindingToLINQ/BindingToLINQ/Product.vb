...
Public Class Product
    ...
    Public Sub New(ByVal id_Renamed As Integer, ByVal description_Renamed As String, ByVal price_Renamed As Double)
    ...
    Public Property Price() As Double
        Get
            Return Me.price_Renamed
        End Get
        Set(ByVal value As Double)
            Me.price_Renamed = value
