...
Public Partial Class RadAboutBox1
    ...
    Friend WithEvents radLabelProductName As Telerik.WinControls.UI.RadLabel
    Friend WithEvents radLabelVersion As Telerik.WinControls.UI.RadLabel
    Friend WithEvents radLabelCopyright As Telerik.WinControls.UI.RadLabel
    Friend WithEvents radLabelCompanyName As Telerik.WinControls.UI.RadLabel
    Friend WithEvents radTextBoxDescription As Telerik.WinControls.UI.RadTextBox
    Friend WithEvents okRadButton As Telerik.WinControls.UI.RadButton
End Class
