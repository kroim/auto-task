    ...
    public partial class AdventureWorksDataSet : global::System.Data.DataSet {
        ...
        public partial class ContactDataTable : global::System.Data.TypedTableBase<ContactRow> {
            ...
            private void InitClass() {
                ...
                this.columnAdditionalContactInfo.MaxLength = 1073741823;
...
namespace _08_VirtualMode.AdventureWorksDataSetTableAdapters {
    ...
    public partial class ContactTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [AdventureWorks].[Person].[Contact] WHERE (([ContactID] = ?) AND ([NameStyle] = ?) AND ((? = 1 AND [Title] IS NULL) OR ([Title] = ?)) AND ([FirstName] = ?) AND ((? = 1 AND [MiddleName] IS NULL) OR ([MiddleName] = ?)) AND ([LastName] = ?) AND ((? = 1 AND [Suffix] IS NULL) OR ([Suffix] = ?)) AND ((? = 1 AND [EmailAddress] IS NULL) OR ([EmailAddress] = ?)) AND ([EmailPromotion] = ?) AND ((? = 1 AND [Phone] IS NULL) OR ([Phone] = ?)) AND ([PasswordHash] = ?) AND ([PasswordSalt] = ?) AND ([rowguid] = ?) AND ([ModifiedDate] = ?))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [AdventureWorks].[Person].[Contact] ([NameStyle], [Title], [FirstName], [MiddleName], [LastName], [Suffix], [EmailAddress], [EmailPromotion], [Phone], [PasswordHash], [PasswordSalt], [AdditionalContactInfo], [rowguid], [ModifiedDate]) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
            ...
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("AdditionalContactInfo", global::System.Data.SqlDbType.NVarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "AdditionalContactInfo", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [AdventureWorks].[Person].[Contact] SET [NameStyle] = ?, [Title] = ?, [FirstName] = ?, [MiddleName] = ?, [LastName] = ?, [Suffix] = ?, [EmailAddress] = ?, [EmailPromotion] = ?, [Phone] = ?, [PasswordHash] = ?, [PasswordSalt] = ?, [AdditionalContactInfo] = ?, [rowguid] = ?, [ModifiedDate] = ? WHERE (([ContactID] = ?) AND ([NameStyle] = ?) AND ((? = 1 AND [Title] IS NULL) OR ([Title] = ?)) AND ([FirstName] = ?) AND ((? = 1 AND [MiddleName] IS NULL) OR ([MiddleName] = ?)) AND ([LastName] = ?) AND ((? = 1 AND [Suffix] IS NULL) OR ([Suffix] = ?)) AND ((? = 1 AND [EmailAddress] IS NULL) OR ([EmailAddress] = ?)) AND ([EmailPromotion] = ?) AND ((? = 1 AND [Phone] IS NULL) OR ([Phone] = ?)) AND ([PasswordHash] = ?) AND ([PasswordSalt] = ?) AND ([rowguid] = ?) AND ([ModifiedDate] = ?))";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("AdditionalContactInfo", global::System.Data.SqlDbType.NVarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "AdditionalContactInfo", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::_08_VirtualMode.Properties.Settings.Default.AdventureWorksConnectionString1;
        }
        ...
        public virtual int Fill(AdventureWorksDataSet.ContactDataTable dataTable) {
        ...
        public virtual AdventureWorksDataSet.ContactDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            AdventureWorksDataSet.ContactDataTable dataTable = new AdventureWorksDataSet.ContactDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(AdventureWorksDataSet.ContactDataTable dataTable) {
        ...
        public virtual int Insert(bool NameStyle, string Title, string FirstName, string MiddleName, string LastName, string Suffix, string EmailAddress, int EmailPromotion, string Phone, string PasswordHash, string PasswordSalt, string AdditionalContactInfo, System.Guid rowguid, System.DateTime ModifiedDate) {
            ...
            if ((AdditionalContactInfo == null)) {
                ...
                this.Adapter.InsertCommand.Parameters[11].Value = ((string)(AdditionalContactInfo));
            }
        ...
        public virtual int Update(
            ...
            if ((AdditionalContactInfo == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[11].Value = ((string)(AdditionalContactInfo));
            }
