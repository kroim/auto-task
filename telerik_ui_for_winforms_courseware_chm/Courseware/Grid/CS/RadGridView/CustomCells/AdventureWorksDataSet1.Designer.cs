...
namespace _15_CustomCells {
    ...
    public partial class AdventureWorksDataSet1 : global::System.Data.DataSet {
        ...
        public partial class ProductDataTable : global::System.Data.TypedTableBase<ProductRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public ProductRow AddProductRow(string Name, string Color) {
...
namespace _15_CustomCells.AdventureWorksDataSet1TableAdapters {
    ...
    public partial class ProductTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [Production].[Product] WHERE (([ProductID] = @Original_ProductID) AND" +
                " ([Name] = @Original_Name) AND ((@IsNull_Color = 1 AND [Color] IS NULL) OR ([Col" +
                "or] = @Original_Color)))";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [Production].[Product] SET [Name] = @Name, [Color] = @Color WHERE (([ProductID] = @Original_ProductID) AND ([Name] = @Original_Name) AND ((@IsNull_Color = 1 AND [Color] IS NULL) OR ([Color] = @Original_Color)));
SELECT ProductID, Name, Color FROM Production.Product WHERE (ProductID = @ProductID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::_15_CustomCells.Properties.Settings.Default.AdventureWorksConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ProductID, Name, Color FROM Production.Product";
        ...
        public virtual int Fill(AdventureWorksDataSet1.ProductDataTable dataTable) {
        ...
        public virtual AdventureWorksDataSet1.ProductDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            AdventureWorksDataSet1.ProductDataTable dataTable = new AdventureWorksDataSet1.ProductDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(AdventureWorksDataSet1.ProductDataTable dataTable) {
        ...
        public virtual int Delete(int Original_ProductID, string Original_Name, string Original_Color) {
        ...
        public virtual int Update(string Name, string Color, int Original_ProductID, string Original_Name, string Original_Color, int ProductID) {
            if ((Name == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Color, int Original_ProductID, string Original_Name, string Original_Color) {
            return this.Update(Name, Color, Original_ProductID, Original_Name, Original_Color, Original_ProductID);
        }
    }
