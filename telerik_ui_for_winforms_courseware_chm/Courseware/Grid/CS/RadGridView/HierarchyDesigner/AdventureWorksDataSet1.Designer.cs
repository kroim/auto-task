...
namespace _05_HierarchyDesigner {
    ...
    public partial class AdventureWorksDataSet1 : global::System.Data.DataSet {
        ...
        public partial class EmployeeDepartmentHistoryDataTable : global::System.Data.TypedTableBase<EmployeeDepartmentHistoryRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public EmployeeDepartmentHistoryRow AddEmployeeDepartmentHistoryRow(int EmployeeID, DepartmentRow parentDepartmentRowByFK_EmployeeDepartmentHistory_Department_DepartmentID, byte ShiftID, System.DateTime StartDate, System.DateTime EndDate, System.DateTime ModifiedDate) {
...
namespace _05_HierarchyDesigner.AdventureWorksDataSet1TableAdapters {
    ...
    public partial class DepartmentTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [AdventureWorks].[HumanResources].[Department] WHERE (([DepartmentID]" +
                " = ?) AND ([Name] = ?) AND ([GroupName] = ?) AND ([ModifiedDate] = ?))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [AdventureWorks].[HumanResources].[Department] ([Name], [GroupName], " +
                "[ModifiedDate]) VALUES (?, ?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [AdventureWorks].[HumanResources].[Department] SET [Name] = ?, [GroupName]" +
                " = ?, [ModifiedDate] = ? WHERE (([DepartmentID] = ?) AND ([Name] = ?) AND ([Grou" +
                "pName] = ?) AND ([ModifiedDate] = ?))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::_05_HierarchyDesigner.Properties.Settings.Default.AdventureWorksConnectionString1;
        }
        ...
        public virtual int Fill(AdventureWorksDataSet1.DepartmentDataTable dataTable) {
        ...
        public virtual AdventureWorksDataSet1.DepartmentDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            AdventureWorksDataSet1.DepartmentDataTable dataTable = new AdventureWorksDataSet1.DepartmentDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(AdventureWorksDataSet1.DepartmentDataTable dataTable) {
    ...
    public partial class EmployeeDepartmentHistoryTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [AdventureWorks].[HumanResources].[EmployeeDepartmentHistory] WHERE (" +
                "([EmployeeID] = ?) AND ([DepartmentID] = ?) AND ([ShiftID] = ?) AND ([StartDate]" +
                " = ?) AND ((? = 1 AND [EndDate] IS NULL) OR ([EndDate] = ?)) AND ([ModifiedDate]" +
                " = ?))";
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO [AdventureWorks].[HumanResources].[EmployeeDepartmentHistory] ([Emplo" +
                "yeeID], [DepartmentID], [ShiftID], [StartDate], [EndDate], [ModifiedDate]) VALUE" +
                "S (?, ?, ?, ?, ?, ?)";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [AdventureWorks].[HumanResources].[EmployeeDepartmentHistory] SET [EmployeeID] = ?, [DepartmentID] = ?, [ShiftID] = ?, [StartDate] = ?, [EndDate] = ?, [ModifiedDate] = ? WHERE (([EmployeeID] = ?) AND ([DepartmentID] = ?) AND ([ShiftID] = ?) AND ([StartDate] = ?) AND ((? = 1 AND [EndDate] IS NULL) OR ([EndDate] = ?)) AND ([ModifiedDate] = ?))";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT EmployeeID, DepartmentID, ShiftID, StartDate, EndDate, ModifiedDate FROM H" +
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, true)]
        public virtual int Fill(AdventureWorksDataSet1.EmployeeDepartmentHistoryDataTable dataTable) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, true)]
        public virtual AdventureWorksDataSet1.EmployeeDepartmentHistoryDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            AdventureWorksDataSet1.EmployeeDepartmentHistoryDataTable dataTable = new AdventureWorksDataSet1.EmployeeDepartmentHistoryDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
        }
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(AdventureWorksDataSet1.EmployeeDepartmentHistoryDataTable dataTable) {
            return this.Adapter.Update(dataTable);
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Delete, true)]
        public virtual int Delete(int Original_EmployeeID, short Original_DepartmentID, byte Original_ShiftID, System.DateTime Original_StartDate, global::System.Nullable<global::System.DateTime> Original_EndDate, System.DateTime Original_ModifiedDate) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, true)]
        public virtual int Insert(int EmployeeID, short DepartmentID, byte ShiftID, System.DateTime StartDate, global::System.Nullable<global::System.DateTime> EndDate, System.DateTime ModifiedDate) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int EmployeeID, short DepartmentID, byte ShiftID, System.DateTime StartDate, global::System.Nullable<global::System.DateTime> EndDate, System.DateTime ModifiedDate, int Original_EmployeeID, short Original_DepartmentID, byte Original_ShiftID, System.DateTime Original_StartDate, global::System.Nullable<global::System.DateTime> Original_EndDate, System.DateTime Original_ModifiedDate) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(global::System.Nullable<global::System.DateTime> EndDate, System.DateTime ModifiedDate, int Original_EmployeeID, short Original_DepartmentID, byte Original_ShiftID, System.DateTime Original_StartDate, global::System.Nullable<global::System.DateTime> Original_EndDate, System.DateTime Original_ModifiedDate) {
            return this.Update(Original_EmployeeID, Original_DepartmentID, Original_ShiftID, Original_StartDate, EndDate, ModifiedDate, Original_EmployeeID, Original_DepartmentID, Original_ShiftID, Original_StartDate, Original_EndDate, Original_ModifiedDate);
        }
    }
