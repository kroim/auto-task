...
namespace _04_SortingandFiltering.ProductDataSet1TableAdapters {
    ...
    public partial class ProductTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [AdventureWorks].[Production].[Product] WHERE (([ProductID] = ?) AND ([Name] = ?) AND ([ProductNumber] = ?) AND ([MakeFlag] = ?) AND ([FinishedGoodsFlag] = ?) AND ((? = 1 AND [Color] IS NULL) OR ([Color] = ?)) AND ([SafetyStockLevel] = ?) AND ([ReorderPoint] = ?) AND ([StandardCost] = ?) AND ([ListPrice] = ?) AND ((? = 1 AND [Size] IS NULL) OR ([Size] = ?)) AND ((? = 1 AND [SizeUnitMeasureCode] IS NULL) OR ([SizeUnitMeasureCode] = ?)) AND ((? = 1 AND [WeightUnitMeasureCode] IS NULL) OR ([WeightUnitMeasureCode] = ?)) AND ((? = 1 AND [Weight] IS NULL) OR ([Weight] = ?)) AND ([DaysToManufacture] = ?) AND ((? = 1 AND [ProductLine] IS NULL) OR ([ProductLine] = ?)) AND ((? = 1 AND [Class] IS NULL) OR ([Class] = ?)) AND ((? = 1 AND [Style] IS NULL) OR ([Style] = ?)) AND ((? = 1 AND [ProductSubcategoryID] IS NULL) OR ([ProductSubcategoryID] = ?)) AND ((? = 1 AND [ProductModelID] IS NULL) OR ([ProductModelID] = ?)) AND ([SellStartDate] = ?) AND ((? = 1 AND [SellEndDate] IS NULL) OR ([SellEndDate] = ?)) AND ((? = 1 AND [DiscontinuedDate] IS NULL) OR ([DiscontinuedDate] = ?)) AND ([rowguid] = ?) AND ([ModifiedDate] = ?))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [AdventureWorks].[Production].[Product] ([Name], [ProductNumber], [MakeFlag], [FinishedGoodsFlag], [Color], [SafetyStockLevel], [ReorderPoint], [StandardCost], [ListPrice], [Size], [SizeUnitMeasureCode], [WeightUnitMeasureCode], [Weight], [DaysToManufacture], [ProductLine], [Class], [Style], [ProductSubcategoryID], [ProductModelID], [SellStartDate], [SellEndDate], [DiscontinuedDate], [rowguid], [ModifiedDate]) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [AdventureWorks].[Production].[Product] SET [Name] = ?, [ProductNumber] = " +
                "?, [MakeFlag] = ?, [FinishedGoodsFlag] = ?, [Color] = ?, [SafetyStockLevel] = ?," +
                " [ReorderPoint] = ?, [StandardCost] = ?, [ListPrice] = ?, [Size] = ?, [SizeUnitM" +
                "easureCode] = ?, [WeightUnitMeasureCode] = ?, [Weight] = ?, [DaysToManufacture] " +
                "= ?, [ProductLine] = ?, [Class] = ?, [Style] = ?, [ProductSubcategoryID] = ?, [P" +
                "roductModelID] = ?, [SellStartDate] = ?, [SellEndDate] = ?, [DiscontinuedDate] =" +
                " ?, [rowguid] = ?, [ModifiedDate] = ? WHERE (([ProductID] = ?) AND ([Name] = ?) " +
                "AND ([ProductNumber] = ?) AND ([MakeFlag] = ?) AND ([FinishedGoodsFlag] = ?) AND" +
                " ((? = 1 AND [Color] IS NULL) OR ([Color] = ?)) AND ([SafetyStockLevel] = ?) AND" +
                " ([ReorderPoint] = ?) AND ([StandardCost] = ?) AND ([ListPrice] = ?) AND ((? = 1" +
                " AND [Size] IS NULL) OR ([Size] = ?)) AND ((? = 1 AND [SizeUnitMeasureCode] IS N" +
                "ULL) OR ([SizeUnitMeasureCode] = ?)) AND ((? = 1 AND [WeightUnitMeasureCode] IS " +
                "NULL) OR ([WeightUnitMeasureCode] = ?)) AND ((? = 1 AND [Weight] IS NULL) OR ([W" +
                "eight] = ?)) AND ([DaysToManufacture] = ?) AND ((? = 1 AND [ProductLine] IS NULL" +
                ") OR ([ProductLine] = ?)) AND ((? = 1 AND [Class] IS NULL) OR ([Class] = ?)) AND" +
                " ((? = 1 AND [Style] IS NULL) OR ([Style] = ?)) AND ((? = 1 AND [ProductSubcateg" +
                "oryID] IS NULL) OR ([ProductSubcategoryID] = ?)) AND ((? = 1 AND [ProductModelID" +
                "] IS NULL) OR ([ProductModelID] = ?)) AND ([SellStartDate] = ?) AND ((? = 1 AND " +
                "[SellEndDate] IS NULL) OR ([SellEndDate] = ?)) AND ((? = 1 AND [DiscontinuedDate" +
                "] IS NULL) OR ([DiscontinuedDate] = ?)) AND ([rowguid] = ?) AND ([ModifiedDate] " +
                "= ?))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::_04_SortingandFiltering.Properties.Settings.Default.AdventureWorksConnectionString1;
        }
        ...
        public virtual int Fill(ProductDataSet1.ProductDataTable dataTable) {
        ...
        public virtual ProductDataSet1.ProductDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            ProductDataSet1.ProductDataTable dataTable = new ProductDataSet1.ProductDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(ProductDataSet1.ProductDataTable dataTable) {
