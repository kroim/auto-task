...
Partial Class RadForm1
  ...
  Private Sub InitializeComponent()
        ...
        '		Me.btnSizeModeNormal.Click += New System.EventHandler(Me.SizeModeClick);
        ...
        '		Me.btnSizeModeStretch.Click += New System.EventHandler(Me.SizeModeClick);
        ...
        '		Me.btnSizeModeAutoSize.Click += New System.EventHandler(Me.SizeModeClick);
        ...
        '		Me.btnSizeModeCenterImage.Click += New System.EventHandler(Me.SizeModeClick);
        ...
        '		Me.btnSizeModeZoom.Click += New System.EventHandler(Me.SizeModeClick);
        ...
        Me.cbFlip.ForeColor = System.Drawing.Color.FromArgb((CInt(Fix((CByte(5))))), (CInt(Fix((CByte(5))))), (CInt(Fix((CByte(5))))))
        ...
        '		Me.cbFlip.ToggleStateChanged += New Telerik.WinControls.UI.StateChangedEventHandler(Me.cbFlip_ToggleStateChanged);
        ' 
        ' cbVerticalFlip
        ' 
        Me.cbVerticalFlip.AllowShowFocusCues = True
        Me.cbVerticalFlip.ForeColor = System.Drawing.Color.FromArgb((CInt(Fix((CByte(5))))), (CInt(Fix((CByte(5))))), (CInt(Fix((CByte(5))))))
        ...
        '		Me.cbVerticalFlip.ToggleStateChanged += New Telerik.WinControls.UI.StateChangedEventHandler(Me.HorizVert_ToggleStateChanged);
        ' 
        ' rbRotate
        ' 
        ...
        '		Me.rbRotate.Click += New System.EventHandler(Me.RotateClick);
        ' 
        ' cbHorizontalFlip
        ' 
        Me.cbHorizontalFlip.AllowShowFocusCues = True
        Me.cbHorizontalFlip.ForeColor = System.Drawing.Color.FromArgb((CInt(Fix((CByte(5))))), (CInt(Fix((CByte(5))))), (CInt(Fix((CByte(5))))))
        ...
        '		Me.cbHorizontalFlip.ToggleStateChanged += New Telerik.WinControls.UI.StateChangedEventHandler(Me.HorizVert_ToggleStateChanged);
        ' 
        ' radLabel2
        ' 
        ...
        '		Me.rbFixed3D.Click += New System.EventHandler(Me.BorderStyleClick);
        ' 
        ' rbFixedSingle
        ' 
        ...
        '		Me.rbFixedSingle.Click += New System.EventHandler(Me.BorderStyleClick);
        ' 
        ' rbNone
        ' 
        ...
        '		Me.rbNone.Click += New System.EventHandler(Me.BorderStyleClick);
        ' 
        ' tbBackgroundColor
        ' 
        ...
        '		Me.tbBackgroundColor.ToggleStateChanged += New Telerik.WinControls.UI.StateChangedEventHandler(Me.tbBackgroundColor_ToggleStateChanged);
        ' 
        ' btnLoad
        ' 
    ...
    Friend WithEvents btnSizeModeNormal As Telerik.WinControls.UI.RadMenuButtonItem
