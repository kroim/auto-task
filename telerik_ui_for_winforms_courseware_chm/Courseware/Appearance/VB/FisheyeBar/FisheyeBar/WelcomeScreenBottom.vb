...
Public Class WelcomeScreenBottom
    ...
    Private Sub WelcomeScreenBottom_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            For Each childItem As RadElement In element.Parent.Children
                ...
                If item IsNot Nothing Then
                    ...
                    Else
                        ...
                        scale = If(item.Equals(element), New SizeF(1.1F, 1.1F), New SizeF(0.9F, 0.9F))
