...
Partial Public Class FurnitureDataSet
    ...
    Partial Public Class ProductsDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddProductsRow(ByVal ProductName As String, ByVal Manufacturer As String, ByVal Photo() As Byte) As ProductsRow
            Dim rowProductsRow As ProductsRow = CType(Me.NewRow,ProductsRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, ProductName, Manufacturer, Photo}
...
Namespace FurnitureDataSetTableAdapters
    ...
    Partial Public Class ProductsTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE `Products` SET `ProductName` = ?, `Manufacturer` = ?, `Photo` = ? WHERE (("& _ 
                "`ID` = ?) AND ((? = 1 AND `ProductName` IS NULL) OR (`ProductName` = ?)) AND ((?"& _ 
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.GettingStarted.My.MySettings.Default.FurnitureConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT        ID, ProductName, Manufacturer, Photo"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM            Products"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"ord"& _ 
                "er by ProductName"
        ...
        Public Overloads Overridable Function Delete(ByVal Original_ID As Integer, ByVal Original_ProductName As String, ByVal Original_Manufacturer As String) As Integer
        ...
        Public Overloads Overridable Function Update(ByVal ProductName As String, ByVal Manufacturer As String, ByVal Photo() As Byte, ByVal Original_ID As Integer, ByVal Original_ProductName As String, ByVal Original_Manufacturer As String) As Integer
