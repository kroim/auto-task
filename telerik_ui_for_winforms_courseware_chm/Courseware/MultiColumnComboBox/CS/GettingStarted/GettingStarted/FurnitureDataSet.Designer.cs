...
namespace GettingStarted {
    ...
    public partial class FurnitureDataSet : global::System.Data.DataSet {
        ...
        public partial class ProductsDataTable : global::System.Data.TypedTableBase<ProductsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public ProductsRow AddProductsRow(string ProductName, string Manufacturer, byte[] Photo) {
...
namespace GettingStarted.FurnitureDataSetTableAdapters {
    ...
    public partial class ProductsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `Products` WHERE ((`ID` = ?) AND ((? = 1 AND `ProductName` IS NULL) O" +
                "R (`ProductName` = ?)) AND ((? = 1 AND `Manufacturer` IS NULL) OR (`Manufacturer" +
                "` = ?)))";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `Products` SET `ProductName` = ?, `Manufacturer` = ?, `Photo` = ? WHERE ((" +
                "`ID` = ?) AND ((? = 1 AND `ProductName` IS NULL) OR (`ProductName` = ?)) AND ((?" +
                " = 1 AND `Manufacturer` IS NULL) OR (`Manufacturer` = ?)))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::GettingStarted.Properties.Settings.Default.FurnitureConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT        ID, ProductName, Manufacturer, Photo\r\nFROM            Products\r\nord" +
                "er by ProductName";
        ...
        public virtual int Delete(int Original_ID, string Original_ProductName, string Original_Manufacturer) {
        ...
        public virtual int Update(string ProductName, string Manufacturer, byte[] Photo, int Original_ID, string Original_ProductName, string Original_Manufacturer) {
            if ((ProductName == null)) {
