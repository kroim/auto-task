...
namespace DrillDown {
    ...
    public partial class ChartDataSet : global::System.Data.DataSet {
        ...
        public partial class RevenueDataTable : global::System.Data.TypedTableBase<RevenueRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public RevenueRow AddRevenueRow(int Year, decimal Revenue) {
...
namespace DrillDown.ChartDataSetTableAdapters {
    ...
    public partial class RevenueTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::DrillDown.Properties.Settings.Default.ChartConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT        [Year], SUM(Revenue) AS Revenue\r\nFROM            Revenue\r\nGROUP BY " +
                "[Year]";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.OleDb.OleDbCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT        SUM(Revenue) AS Revenue, [Month]\r\nFROM            Revenue\r\nWHERE   " +
                "     ([Year] = ?) AND (Quarter = ?)\r\nGROUP BY [Month]";
            ...
            this._commandCollection[2].CommandText = "SELECT        SUM(Revenue) AS Revenue, Quarter\r\nFROM            Revenue\r\nwhere [Y" +
                "ear] = ?\r\nGROUP BY Quarter";
