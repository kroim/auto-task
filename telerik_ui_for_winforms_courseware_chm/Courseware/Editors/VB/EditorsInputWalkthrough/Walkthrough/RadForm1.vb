...
Public Class RadForm1
    ...
    Private Sub RadForm1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        AddHandler tbNote.ToolTipTextNeeded, AddressOf HandleToolTipTextNeeded
        AddHandler tbAddress.ToolTipTextNeeded, AddressOf HandleToolTipTextNeeded
        AddHandler tbName.ToolTipTextNeeded, AddressOf HandleToolTipTextNeeded
        AddHandler meState.ToolTipTextNeeded, AddressOf HandleToolTipTextNeeded
        AddHandler meZip.ToolTipTextNeeded, AddressOf HandleToolTipTextNeeded
        AddHandler tbCity.ToolTipTextNeeded, AddressOf HandleToolTipTextNeeded
        AddHandler dtDeliver.ToolTipTextNeeded, AddressOf HandleToolTipTextNeeded
    End Sub
    ...
    Private Sub HandleToolTipTextNeeded(ByVal sender As Object, ByVal e As ToolTipTextNeededEventArgs)
