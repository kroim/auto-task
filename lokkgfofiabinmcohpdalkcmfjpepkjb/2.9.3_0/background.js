...
var ChromeService = function () {
  function ChromeService() {
    (0, _classCallCheck3.default)(this, ChromeService);
  }

  (0, _createClass3.default)(ChromeService, null, [{
    key: 'isPopup',
    ...
    value: function openOptionsPage() {
      var page = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'supreme';

      window.open(chrome.runtime.getURL('index.html#/' + page + '/'));
    }
  }, {
    key: 'createNotification',
    value: function createNotification(title, message, onClick) {
    ...
    key: 'sendMessage',
    value: function sendMessage(key, data) {
      return new _promise2.default(function (resolve) {
        chrome.runtime.sendMessage({ key: key, data: data }, resolve);
      });
    }
  }, {
    key: 'addMessageBroadcastListener',
    value: function addMessageBroadcastListener(func) {
      chrome.runtime.onMessage.addListener(func);
    }
  }, {
    key: 'addMessageListener',
    value: function addMessageListener(key, func) {
...
var updateRestockList = function () {
  var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(products, type) {
    var _restockList;

    var restockList, entries, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, product;
    ...
    return _regenerator2.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return _StorageService2.default.getItem('restocks');

          case 2:
            restockList = _context.sent;
            entries = [];
            ...
            for (_iterator = (0, _getIterator3.default)(products); !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
              product = _step.value;
          ...
          case 23:
            ...
            _context.next = 26;
            return _StorageService2.default.setItem('restocks', entries);

          case 26:
            return _context.abrupt('return');

          case 27:
            (_restockList = restockList).push.apply(_restockList, entries);
            restockList = restockList.sort(function (a, b) {
              return new Date(b.timestamp) - new Date(a.timestamp);
            }).splice(0, 100);
            _context.next = 31;
            return _StorageService2.default.setItem('restocks', restockList);
  ...
  return function updateRestockList(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            return _context2.abrupt('return', profile.Supreme);
...
var canDisplayNotifications = function () {
  var _ref3 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee3() {
    var settings;
    return _regenerator2.default.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 5:
            return _context3.abrupt('return', settings.Options && settings.Options.showNotifications);
  ...
  return function canDisplayNotifications() {
    return _ref3.apply(this, arguments);
  };
}();

var createNotification = function () {
  var _ref4 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee4(title, content, callback) {
    return _regenerator2.default.wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
          ...
          case 2:
            ...
            _ChromeService2.default.createNotification(title, content, callback);
  ...
  return function createNotification(_x3, _x4, _x5) {
    return _ref4.apply(this, arguments);
  };
}();

var onNewProducts = function () {
  var _ref5 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee5(products) {
    var _this = this;
    ...
    return _regenerator2.default.wrap(function _callee5$(_context6) {
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            _context6.next = 2;
            return updateRestockList(products, 'new');
          ...
          case 2:
            ...
            _context6.next = 5;
            return createNotification('New products', products.length + ' new products just landed on the store!', function (notif) {
          ...
          case 7:
                ...
                while (1) {
                  switch (_context5.prev = _context5.next) {
                    case 0:
                      ...
                      _context5.next = 3;
                      return createNotification('New product', 'Product ' + product.name + ' just landed on the store!', function (notif) {
            ...
            _iterator2 = (0, _getIterator3.default)(products);
          ...
          case 32:
            _ChromeService2.default.sendMessage('productsAdded', { products: products });
    ...
    }, _callee5, this, [[10, 20, 24, 32], [25,, 27, 31]]);
  }));

  return function onNewProducts(_x6) {
    return _ref5.apply(this, arguments);
  };
}();

var onProductsRestock = function () {
  var _ref6 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee6(products) {
    var _this2 = this;
    ...
    return _regenerator2.default.wrap(function _callee6$(_context8) {
      while (1) {
        switch (_context8.prev = _context8.next) {
          case 0:
            _context8.next = 2;
            return updateRestockList(products, 'restock');
                ...
                while (1) {
                  switch (_context7.prev = _context7.next) {
                    case 0:
                      ...
                      _ChromeService2.default.sendMessage('productRestocked', { product: product });
                      _context7.next = 4;
                      return createNotification('Restock alert', product.name + ' in ' + product.color + ' is back in stock!', function (notif) {
                        window.open(product.url);
                        notif.close();
                      });
  ...
  return function onProductsRestock(_x7) {
    ...
    return _regenerator2.default.wrap(function _callee9$(_context11) {
      while (1) {
        switch (_context11.prev = _context11.next) {
          case 0:
            monitor = new _RestockMonitor2.default(10000);

            monitor.addOnNewProductsListener(function () {
              var _ref8 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee7(products) {
                return _regenerator2.default.wrap(function _callee7$(_context9) {
                  while (1) {
                    switch (_context9.prev = _context9.next) {
                      case 0:
                        _context9.next = 2;
                        return onNewProducts(products);
            ...
            monitor.addOnProductsRestockListener(function () {
              var _ref9 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee8(products) {
                return _regenerator2.default.wrap(function _callee8$(_context10) {
                  while (1) {
                    switch (_context10.prev = _context10.next) {
                      case 0:
                        _context10.next = 2;
                        return onProductsRestock(products);
...
var _RestockMonitor = __webpack_require__(221);

var _RestockMonitor2 = _interopRequireDefault(_RestockMonitor);

var _StorageService = __webpack_require__(15);

var _StorageService2 = _interopRequireDefault(_StorageService);

var _ChromeService = __webpack_require__(164);
...
var timeout = function () {
  var _ref2 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee2(ms, callback) {
    return _regenerator2.default.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 3:
            ...
            return _context3.abrupt('return', profile.Supreme);
...
var processByMonitor = function () {
    ...
    return _regenerator2.default.wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            _context4.next = 2;
            return _AtcService2.default.runAllMonitor();
  ...
  return function processByMonitor() {
    return _ref4.apply(this, arguments);
  };
}();
...
var loop = function () {
  var _ref5 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee5() {
    var settings, now, startTime, diffTime;
    return _regenerator2.default.wrap(function _callee5$(_context5) {
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
          ...
          case 21:
            _context5.next = 23;
            return _AtcService2.default.runAll();
...
var _AtcService = __webpack_require__(210);
...
function getAtcStartTime(settings) {
  ...
  var atcStartDate = settings[menus.MENU_OPTIONS].atcStartDate;
  if (!atcStartTime || !atcStartDate) {
    return null;
  }
  var time = Helpers.timeToDate(atcStartTime);
  var currDate = new Date(atcStartDate);
...
var MENU_PRODUCTS = exports.MENU_PRODUCTS = 'Products';
...
var _KeywordsService = __webpack_require__(211);
...
var _ProductsService = __webpack_require__(214);
...
var _FuzzyStringMatcher = __webpack_require__(212);
...
var _string_score = __webpack_require__(213);
...
var _browserRequest = __webpack_require__(163);
...
var getKeys  = __webpack_require__(25)
  , gOPS     = __webpack_require__(219)
  , pIE      = __webpack_require__(220)
  , toObject = __webpack_require__(29)
...
var _RestocksService = __webpack_require__(222);

var _RestocksService2 = _interopRequireDefault(_RestocksService);
...
var RestockMonitor = function () {
  function RestockMonitor(intervalMs) {
    (0, _classCallCheck3.default)(this, RestockMonitor);
  ...
  (0, _createClass3.default)(RestockMonitor, [{
    key: 'addOnNewProductsListener',
    value: function addOnNewProductsListener(func) {
      this.onNewProductsCallbacks.push(func);
    }
  }, {
    key: 'addOnProductsRestockListener',
    value: function addOnProductsRestockListener(func) {
    ...
    value: function () {
      var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee() {
        var newStock, savedStock, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, callback, newProducts, _iteratorNormalCompletion2, _didIteratorError2, _iteratorError2, _iterator2, _step2, _callback, restockedProducts, _loop, i, _iteratorNormalCompletion3, _didIteratorError3, _iteratorError3, _iterator3, _step3, _callback2;
        ...
        return _regenerator2.default.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return _RestocksService2.default.fetchCurrentStock();

              case 2:
                newStock = _context.sent;
                _context.next = 5;
                return _StorageService2.default.getItem('stock');

              case 5:
                savedStock = _context.sent;
                ...
                for (_iterator = (0, _getIterator3.default)(this.onNewProductsCallbacks); !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
              ...
              case 26:
                _context.next = 28;
                return _StorageService2.default.setItem('stock', newStock);

              case 28:
                return _context.abrupt('return');

              case 29:
                newProducts = newStock.filter(function (x) {
                  return !savedStock.find(function (z) {
                    return z.url === x.url;
                  });
                });
                ...
                for (_iterator2 = (0, _getIterator3.default)(this.onNewProductsCallbacks); !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
                  _callback = _step2.value;
                  _callback(newProducts);
                }_context.next = 42;
                break;
              ...
              case 50:
                ...
                _loop = function _loop(i) {
                  var product = newStock[i];
                  var existingProduct = savedStock.find(function (x) {
                    return x.url === product.url;
                  });
                ...
                for (_iterator3 = (0, _getIterator3.default)(this.onProductsRestockCallbacks); !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
                  _callback2 = _step3.value;
                  _callback2(restockedProducts);
                }_context.next = 65;
                break;
              ...
              case 75:
                _ChromeService2.default.sendMessage('stockUpdated', newStock);
        ...
        }, _callee, this, [[10, 14, 18, 26], [19,, 21, 25], [34, 38, 42, 50], [43,, 45, 49], [57, 61, 65, 73], [66,, 68, 72]]);
      }));
    ...
    value: function start() {
      ...
      this.interval = setInterval((0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee2() {
        return _regenerator2.default.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
...
exports.default = RestockMonitor;
...
var RestocksService = function () {
  function RestocksService() {
    (0, _classCallCheck3.default)(this, RestocksService);
  }

  (0, _createClass3.default)(RestocksService, null, [{
    key: 'fetchCurrentStock',
    value: function () {
      var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee() {
        var locale;
        return _regenerator2.default.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return _StorageService2.default.getItem('locale');
              ...
              case 5:
                ...
                return _context.abrupt('return', new _promise2.default(function (resolve, reject) {
                  var url = locale === 'us' ? 'https://api.openaio.com/us/stock' : 'https://api.openaio.com/stock';
                  (0, _browserRequest2.default)({ url: url }, function (error, response, body) {
                    if (!error && response.statusCode === 200) {
                      try {
      ...
      return fetchCurrentStock;
    }()
  }]);
  return RestocksService;
}();

exports.default = RestocksService;
